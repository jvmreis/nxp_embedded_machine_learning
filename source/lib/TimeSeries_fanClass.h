...
#ifndef _TIMESERIES_fanClass_H_
#define _TIMESERIES_fanClass_H_

#define CLASSIFICATION_LIB_ID_fanClass "539ff4f"

#define TSS_INPUT_DATA_LEN_fanClass                           (512)
#define TSS_INPUT_DATA_DIM_fanClass                           (3)

#define USE_CLASSIFICATION_fanClass
#define TSS_CLASS_NUMBER_fanClass                             (4)
 ...
 */
tss_status tss_cls_init_fanClass(void);
 ...
 */
tss_status tss_cls_predict_fanClass(const float data_input[], float probabilities[], int *class_index);

#ifdef __cplusplus
}
#endif

#endif /* _TIMESERIES_fanClass_H_ */